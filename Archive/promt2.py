...
def main():
    ...
    team_collections = {
        "Team A": ["HR Policies", "IT Policies", "Team A Specific"],
        "Team B": ["HR Policies", "IT Policies", "Team B Specific"]
    }
    
    available_collections = team_collections.get(user_team, ["Default"])
    selected_collection = st.sidebar.selectbox("Choose policy database", available_collections)
